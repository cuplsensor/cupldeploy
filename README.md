...
4. The command ``docker-compose --context remote pull`` causes the 3 Docker images defined in [docker-compose.yml](docker-compose.yml) to be downloaded from DockerHub.

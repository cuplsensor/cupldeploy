...
6. Select the same datacenter that your droplet is in (*example* San Francisco 3). 
   ![image-20210801131134395](C:\Users\malco\AppData\Roaming\Typora\typora-user-images\image-20210801131134395.png)
...
10. Under **Add trusted sources** enter the name of your droplet. 
    ![image-20210801132313788](C:\Users\malco\AppData\Roaming\Typora\typora-user-images\image-20210801132313788.png)
...
15. Under **Add new database** enter ``latest-lpuc-db`` followed by **Save**. An empty database will be created.
    ![image-20210801133623482](C:\Users\malco\AppData\Roaming\Typora\typora-user-images\image-20210801133623482.png)

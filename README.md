...
2. Select **Users** from the left-hand menu.
   ![image-20210811095253005](docs/screenshots/image-20210811095253005.png)
3. Select **Add users**.
...
8. Select **Review** ([screenshot](docs/screenshots/image-20210811104002620.png)).
9. Select **Confirm and request**.
10. Open the drop down for your domain and select **Create record in Route 53**.
    ![image-20210811104227816](docs/screenshots/image-20210811104227816.png)
...
![image-20210813003813247](docs/screenshots/image-20210813003813247.png)
...
![image-20210813002033363](docs/screenshots/image-20210813002033363.png)

##### Test cuplfrontend

In a web browser, navigate to ``latest.f.ROOT_DOMAIN`` (*example* ``latest.f.lpuc.uk``). Expect to see:

![image-20210813005419721](docs/screenshots/image-20210813005419721.png)

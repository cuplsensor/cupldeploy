...
The application is hosted at a domain, for example: [latest.f.cupl.uk](https://latest.f.cupl.uk), which is registered to the [Amazon Route53](https://docs.aws.amazon.com/route53/?id=docs_gateway) DNS server. 
